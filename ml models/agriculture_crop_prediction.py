...
accurancy = sm.r2_score(Y_test,Y_predict)
#print(accurancy)
...
#accuran=sm.r2_score(Y_test,Y_predict1)

#print(accuran)

# import joblib
# joblib.dump(model,'fianl_pickle_mdl_crop.pkl')

with open('yield','wb') as f:
       pickle.dump(model,f)

# final_mdl=joblib.load('fianl_pickle_mdl_crop.pkl')
